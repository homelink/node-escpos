...
Printjob.prototype = {
    ...
    qrCode: function (code) {
		...
		var buf2 = iconv.encode(code, 'cp936');
		var len = code.length+1;
		var buf1 = new Buffer([0x1b,0x5a,0,'L',8,len,0,1]);
		this._queue.push(buf1);
		this._queue.push(buf2);
        return this;
    },
    ...
    text: function (text) {
        ...
        this._queue.push(iconv.encode(text, 'cp936'));
